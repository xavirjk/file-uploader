...
void Mainview::setUpHome(){
    ...
    connect(upldBtn,&QAbstractButton::clicked,this,&Mainview::toggleUploadsView);
    connect(dnldBtn,&QAbstractButton::clicked,this,&Mainview::toggleDownloadsView);
...
void Mainview::toggleUploadsView(){
...
void Mainview::toggleDownloadsView(){
    hbox2 ->itemAt(0) ->widget()->setVisible(false);
    hbox2 ->removeWidget(hbox2->itemAt(0)->widget());
